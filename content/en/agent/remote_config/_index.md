...
Remote Configuration works in environments where the Datadog Agent is deployed. Remote Configuration is supported for a Serverless Container cloud service such as AWS Fargate. Remote Configuration does not support Serverless Container Managed Apps (AWS App Runner, Azure Container Apps, Google Cloud Run) and Functions deployed with Container Packaging (AWS Lambda, Azure Functions, Google Cloud Functions)
.
## Further Reading
